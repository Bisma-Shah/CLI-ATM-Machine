...
console.log(chalk.bold.rgb(284, 284, 284)(`<<<=======>>> ${chalk.bold.hex(`#33FFF5`)(`Welcome to \`Bisma Shah\` - ATM-Machine App`)}  <<<=========>>>`));
console.log(chalk.bold.rgb(284, 284, 284)(`\t\t <<<==============================>>>\n`));
...
console.log(chalk.whiteBright.bold("Thank You for choosing" + "\n" + "\t" + "UBL"));
